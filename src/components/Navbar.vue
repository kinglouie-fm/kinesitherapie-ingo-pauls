      ...
      <nav class="navbar navbar-expand-lg navbar-dark p-0">
        ...
        <div id="mainNav" class="collapse navbar-collapse">
          <ul class="navbar-nav ms-3 gap-lg-3">
            ...
            <li class="nav-item">
              <RouterLink class="nav-link text-white" to="/#team">Unser Team</RouterLink>
            </li>
            <li class="nav-item">
              <RouterLink class="nav-link text-white" to="/#leistungen">Leistungen</RouterLink>
            </li>
            <li class="nav-item">
              <RouterLink class="nav-link text-white" to="/#kontakt">Kontakt</RouterLink>
            </li>
          </ul>
        </div>
      </nav>
